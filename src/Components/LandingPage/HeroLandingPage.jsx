  ...
  return (
    <div className="w-full bg-[#f5f2eb] pt-28 min-h-screen flex justify-center">
      <div className="relative flex flex-col items-center lg:flex-row-reverse w-full max-w-6xl">
        ...
        {/* Text Content */}
        <div className="max-w-lg bg-gradient-to-br from-rose-100 via-rose-50 to-rose-200 md:max-w-2xl md:z-10 md:shadow-2xl md:absolute md:top-1/2 md:-translate-y-1/2 lg:w-3/5 lg:left-0 lg:ml-20 xl:ml-12 rounded-3xl border border-rose-300">
